...
<script>function onRide(){
    alert("Booking Done");
}</script>

<div class="home">
    <div class="row setbg">
        <img class="img-fluid web" src="images/Group 51 (2).png" alt="home">
        ...
        <div class="col-sm-4 book px-5 pt-5 top">
            ...
            <form  method="POST">
                <div class="form-group mb-3 mt-5">
                    <input type="text" class="form-control" name="dropin" placeholder="Drop in">
                    <form action="index (1).php" method="post"></form>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" name="dropout" placeholder="Drop out">
                </div>
                <div class="row">
                  
                    <div class="form-group col-sm-6">
                        <label for="time_schedule">As Per Schedule</label>
                        <input type="time" class="form-control" placeholder="hrs:mins" name="time">
                    </div>
                </div>
                <div class="form-group">
                    <input type="submit" onClick=onRide()  class="btn btn-secondary btn-block mt-2" name="order" value="GO RIDE" >
